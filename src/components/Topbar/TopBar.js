  ...
  return (
    <div className=" h-[70px] fixed left-0 right-0 top-0 z-10 flex ">
      ...
      <div className="flex justify-between bg-[#2b3d51] flex-1">
        ...
        <div className="flex ">
          <i className="fa-solid fa-bell leading-[70px] text-[white] text-[22px] px-[16px] mr-[8px]"></i>
          <i className="fa-solid fa-envelope leading-[70px] text-[white] text-[22px] px-[16px] mr-[8px]"></i>
          <i className="fa-solid fa-bars-staggered leading-[70px] text-[white] text-[22px] px-[16px] mr-[8px]"></i>
          <a className="">
            <img
